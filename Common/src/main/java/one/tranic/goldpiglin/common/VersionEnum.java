...
public enum VersionEnum {
    ...
    V1_21(1210), V1_21_1(1211), V1_21_2(1212), V1_21_3(1213), V1_21_4(1214), V1_21_5(1215);
    ...
    public static VersionEnum getVersion() {
        ...
        if (bukkit.contains("1.21.5")) {
            version = V1_21_5;
        } else if (bukkit.contains("1.21.4")) {
            version = V1_21_4;
            ...
            version = V1_21;
        } else if (bukkit.contains("1.20.6")) {
            version = V1_20_6;
        } else if (bukkit.contains("1.20.5")) {
            version = V1_20_5;
